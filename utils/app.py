...
def allow_https():
    ...
    // Thanks Powercord <3
    // Source: https://github.com/powercord-org/powercord/blob/0922d2cc34afe482d9a28d526545254f5b8568f4/src/patcher.js#L102-L116
...
def main(arguments: str = None):
    ...
    print(
        f'\nDone!\n'
        f'\nYou may now edit your {os.path.abspath(args.css)} file,\n'
        f"which will be reloaded whenever it's saved.\n"
